            ...
            <div className="flex flex-col items-center w-full overflow-hidden placeholder:text-(--twitter-gray-800) bg-(--twitter-gray-50) rounded-3xl py-2 text-lg leading-6">
              <div className="flex justify-end w-full px-2">
                ...
                <div className="self-end h-8">
                  <button
                    className={`inline-flex items-center gap-1 justify-center w-8 h-8 text-(--twitter-white) bg-(--twitter-blue) hover:bg-(--twitter-blue-hover) rounded-full cursor-pointer transition-opacity duration-200 fade-in-out 
