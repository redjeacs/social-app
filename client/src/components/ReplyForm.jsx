...
function ReplyForm() {
  ...
  const handleReplySubmit = async (e) => {
    ...
    try {
      ...
      setAlert({
        type: "error",
        message: `An error occured - ${err.message || err.statusText}`,
      });
      ...
      <div className="relative flex flex-col flex-1">
        <div className="">
          ...
          {selectedImages.length > 0 && (
            <div
              className={`w-full relative rounded overflow-hidden ${selectedImages.length > 2 ? "grid grid-cols-2 gap-1" : "flex gap-1"}`}
            >
              {selectedImages.map((image, index) => (
                <div
                  key={index}
                  className="relative w-full h-full aspect-square p-1"
                >
                  <img
                    src={image.file}
                    alt={`selected ${index}`}
          ...
          >
              ...
              <div className="flex justify-between items-center mt-1 relative">
                <div className="flex">
                  ...
                  >
                    ...
                    <DropdownMenuContent className="w-64 p-2 bg-black border-black custom-scrollbar z-10 outline">
                      <input
                        type="text"
                  ...
                  >
                    ...
                    <DropdownMenuContent className="p-0 bg-transparent border-0 z-10">
                      <EmojiPicker
            ...
            <Button
              ...
              disabled={
                (reply.trim() === "" && selectedImages.length === 0) ||
                isSubmittingReply
              }
            >
              Reply
